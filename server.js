...
app.post('/identify-item', async (req, res) => {
    try {
        ...
        **相手を呼ぶときは必ず「${name}さん」と呼んでください。絶対に呼び捨てにしてはいけません。**
        ...
        【解説のルール】
        1. **ネル先生の解説**: 猫視点でのユーモラスな解説。語尾は「にゃ」。**文字数は120文字程度（100文字から140文字の間）で詳しく書いてください。**
        2. **本当の解説**: 子供向けの学習図鑑のような、正確でためになる豆知識や説明。です・ます調。**文字数は120文字程度（100文字から140文字の間）で詳しく書いてください。**
