// --- analyze.js (完全版 v290.0: コード展開・完全復元版) ---
...
window.selectMode = function(m) {
    try {
        ...
        if (m === 'chat') { 
            ...
            document.getElementById('live-chat-video-container-free').style.display = 'none'; // 初期非表示
