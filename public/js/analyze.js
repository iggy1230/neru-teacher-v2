...
const sfxOver = new Audio('assets/sounds/system/gameover.mp3');
const sfxBunseki = new Audio('assets/sounds/system/bunseki.mp3'); 
sfxBunseki.volume = 0.05; 
const sfxHirameku = new Audio('assets/sounds/voice/hirameku.mp3'); 
const sfxMaru = new Audio('assets/sounds/ui/maru.mp3');
...
const defaultIcon = 'assets/images/characters/nell-normal.png'; 
const talkIcon = 'assets/images/characters/nell-talk.png';
