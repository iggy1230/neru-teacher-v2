// --- js/game-engine.js (完全版 v392.0: 神経衰弱演出強化版) ---
...
// ==========================================
// ... (既存の漢字ドリルのコードはそのまま維持)
// ... (省略: nextKanjiQuestion, checkKanji, checkKanjiReading, giveUpKanji, sendHttpTextInternal, etc. は元のまま)
...
function rememberCard(index, id) {
    ...
    if (Math.random() < chance) {
        memoryGameState.nellMemory[index] = id;
    }
}
...
function nellTurn() {
    ...
    const unMatchedIndices = memoryGameState.deck
