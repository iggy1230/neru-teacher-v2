...
const idBase = new Image(); idBase.crossOrigin = "Anonymous"; idBase.src = 'student-id-base.png?' + new Date().getTime();
const decoEars = new Image(); decoEars.crossOrigin = "Anonymous"; decoEars.src = 'ears.png?' + new Date().getTime();
const decoMuzzle = new Image(); decoMuzzle.crossOrigin = "Anonymous"; decoMuzzle.src = 'muzzle.png?' + new Date().getTime();
...
window.showEnrollment = function() {
    ...
    if (slot) { slot.innerHTML = ""; slot.style.display = 'block'; } if (baseImg) baseImg.src = "student-id-base.png";
